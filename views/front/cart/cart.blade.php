...
<a href="javascript:void(0)" class="d-flex align-items-center text-dark px-3 h-100" data-toggle="dropdown" data-display="static" title="{{tran('Cart')}}">
    <span class="mr-2">
    ...
    <span class="nav-box-text d-none d-xl-block ml-2 text-white fs-12">
        (<span class="cart-count">{{(isset($cart) && count($cart) > 0) ? count($cart) : 0 }}</span> {{tran('Items')}})
    </span>
</a>
...
<div class="dropdown-menu dropdown-menu-right dropdown-menu-lg p-0 stop-propagation rounded-0">
    @if (isset($cart) && count($cart) > 0)
        ...
        <div class="px-3 py-2 fs-15 border-top d-flex justify-content-between mx-4" style="border-color: #e5e5e5 !important;">
            <span class="fs-14 fw-400 text-secondary">{{ tran('Subtotal') }}</span>
        ...
        <div class="py-3 text-center border-top mx-4" style="border-color: #e5e5e5 !important;">
            <div class="row gutters-10 justify-content-center">
                <div class="col-sm-6 mb-2">
                    <a href="#" class="btn btn-warning btn-sm btn-block rounded-4 text-white">
                        {{ tran('View cart') }}
                    </a>
                </div>
                @if (Auth::check())
                @if ($total > 0)
                <div class="col-sm-6">
                    <a href="#" class="btn btn-primary btn-sm btn-block rounded-4">
                        {{ tran('Checkout') }}
                    </a>
                </div>
                @endif
