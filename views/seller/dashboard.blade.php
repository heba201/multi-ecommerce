...
@media only screen and (max-width : 320px) {
  ...
  .product_values .product_buttons {
    ...
    <div class="aiz-titlebar mt-2 mb-4">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3 text-primary">{{ tran('Dashboard') }}</h1>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                  <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
                      ...
                      <p>{{ tran('Products') }}</p>
                        ...
                        <h2> {{ \App\Models\Product::where('user_id', Auth::user()->id)->count() }}</h2>
                      ...
                      <p> {{ tran('Rating') }} </p>
                        ...
                        <h2> {{ Auth::user()->shop->rating }}</h2>
                      </div>
                      <div class="statistics-item">
                      <p>{{ tran('Total Order') }}</p>
                        <p>
                        ...
                        <h2>  {{ \App\Models\Order::where('seller_id', Auth::user()->id)->where('delivery_status', 'delivered')->count() }}</h2>
                        
                      </div>
                      <div class="statistics-item">
                      <p>{{ tran('Total Sales') }}</p>
                        <p>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            ...
            <div class="card shadow-none bg-soft-primary mb-0">
                ...
                <div class="card-body">
                    ...
                    <p>{{ tran('Your Sold Amount (Current month)') }}</p>
                    ...
                    <p class="mt-4">
                        @php
                            $orderTotal = \App\Models\Order::where('seller_id', Auth::user()->id)
                                ...
                                ->sum('grand_total');
                        @endphp
                        {{ tran('Last Month') }}: {{ single_price($orderTotal) }}
                    </p>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            <div class="card shadow-none h-450px mb-0 h-100">
                <div class="card-body">
                    <div class="card-title text-primary fs-16 fw-600">
                        {{ tran('Category wise product count') }}
                    </div>
                    <hr>
                    <ul class="list-group">
                ...
                <div class="card-body">
                    <div class="card-title text-primary fs-16 fw-600">
                        ...
                        <p class="small text-muted mb-0">
                            <span class="fs-12 fw-600">{{ tran('This Month') }}</span>
                        </p>
                    </div>
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            <p class="small text-muted mb-0">
                                ...
                                <span class="fs-13 text-primary fw-600">{{ tran('New Order') }}</span>
                            </p>
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-primary fw-600">{{ tran('Cancelled') }}</span>
                            </p>
                            <h3 class="mb-0" style="color: #A9A3CC">
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-primary fw-600">{{ tran('On Delivery') }}</span>
                            </p>
                            <h3 class="mb-0" style="color: #A9A3CC">
                    ...
                    <div class="row align-items-center mb-4">
                        ...
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-13 text-primary fw-600">{{ tran('Delivered') }}</span>
                            </p>
                            <h3 class="mb-0" style="color: #A9A3CC">
            ...
            <div
                ...
                @if (Auth::user()->shop->verification_status == 0)
                    <div class="my-n4 py-1 text-center">
                        <img src="{{ asset('assets/images/non_verified.png') }}" alt=""
                            class="w-xxl-130px w-90px d-block">
                        <a href="{{ route('shop.verify') }}"
                            class="btn btn-sm btn-primary">{{ tran('Verify Now') }}</a>
                    </div>
                @else
                    <div class="my-2 py-1">
                        <img src="{{ asset('assets/images/verified.png') }}" alt="" width="">
                    </div>
                @endif
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-3">
            <a href="{{ route('money_withdraw_requests.index') }}"
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title text-primary">
                <h6 class="mb-0">{{ tran('Top 12 Products') }}</h6>
  ...
  <li class="product_item">
      ...
      @if($discount_precentage !=0)<p>- {{$discount_precentage}}%</p>@endif
      </div>
      <div class="product_image">
        <a href="{{ route('product.details', $product->slug) }}"><img src="{{$imgf}}" alt=""></a>
      </div>
      <div class="product_values">
        ...
        <div class="product_price">
          <a href="#">@if(home_base_price($product) != home_discounted_base_price($product))<span class="price_old">{{ home_base_price($product) }} @endif</span> <span class="price_new">{{ home_discounted_base_price($product) }}</span></a>
           <span>{{ render_newStarRating($total) }}</span>
        </div>
...
@push('js')
    <script type="text/javascript">
      var currentChartCanvas = $("#graph-1").get(0).getContext("2d");
