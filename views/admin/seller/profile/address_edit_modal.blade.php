<form class="form-default" role="form" action="{{ route('seller.addresses.update', $address_data->id) }}" method="POST">
    ...
    <div class="p-3">
        <div class="row">
            ...
            <div class="col-md-10">
                <textarea class="form-control mb-3" placeholder="{{ tran('Your Address')}}" rows="2" name="address" required>{{ $address_data->address }}</textarea>
            </div>
        </div>
        <div class="row">
            <div class="col-md-2">
            ...
            <div class="col-md-10">
                <div class="mb-3">
                    <select class="form-control aiz-selectpicker" data-live-search="true" data-placeholder="{{ tran('Select your country')}}" name="country_id" id="edit_country" required>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3" placeholder="{{ tran('Your Postal Code')}}" value="{{ $address_data->postal_code }}" name="postal_code" value="" required>
            </div>
        </div>
        <div class="row">
            <div class="col-md-2">
            ...
            <div class="col-md-10">
                <input type="text" class="form-control mb-3" placeholder="{{ tran('+880')}}" value="{{ $address_data->phone }}" name="phone" value="" required>
            </div>
        </div>
