                          ...
                          <tr>
                              ...
                              <td>
                                  @if ($ticket->status == 'pending')
                                      <span class="badge badge-inline badge-danger">{{ tran('Pending')}}</span>
                                  @elseif ($ticket->status == 'open')
                                      <span class="badge badge-inline badge-secondary">{{ tran('Open')}}</span>
                                  @else
                                      <span class="badge badge-inline badge-success">{{ tran('Solved')}}</span>
                                  @endif
                              </td>
                              <td>
              ...
              <div class="modal-body px-3 pt-3">
                  <form class="" action="{{ route('seller.support_ticket.store') }}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-10">
                              <input type="text" class="form-control mb-3" placeholder="{{ tran('Subject')}}" name="subject" required>
                          </div>
                      </div>
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-10">
                              <textarea type="text" class="form-control mb-3" rows="3" name="details" placeholder="{{ tran('Type your reply')}}" data-buttons="bold,underline,italic,|,ul,ol,|,paragraph,|,undo,redo" required></textarea>
                          </div>
                      </div>
                      ...
                      <div class="text-right mt-4">
                          ...
                          <button type="submit" class="btn btn-primary">{{ tran('Send Ticket')}}</button>
                      </div>
                  </form>
              </div>
            </div>
